...
namespace VehicleTracker.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["Type"] = vehicle.Type;
            ViewData["Tires"] = vehicle.TiresNum;
            return View(vehicle);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VehicleID,Type,GasAmount,TiresNum")] Vehicle vehicle)
        {
